...
int ut =0;    // ut is the upper threshold value of signal to that patient which will be auto callibrated
int lt =0;    //same for lt (lower threshold)
  ...
  while (millis() < 5000) {
    ...
    if (sensorValue > sensorMax) {
      sensorMax = sensorValue;
                                                ...
                                                // auto callibrating the threshold for that specific patient
